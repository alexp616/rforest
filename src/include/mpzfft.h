...
// GPU version of params init
static inline
void cu_mpzfft_params_init(mpzfft_params_t* params, size_t bits, unsigned terms,
			   unsigned num_primes, zz_moduli_t* moduli)
{
  cu_zz_mpnfft_params_init(params, bits, terms, num_primes, moduli);
}
...
{
  cu_zz_mpnfft_poly_matrix_mul(C, A, B, dim1, dim2, dim3, num_primes, n);
}
